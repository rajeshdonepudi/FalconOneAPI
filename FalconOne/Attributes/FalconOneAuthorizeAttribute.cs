...
using FalconOne.Enumerations.Tenants;
...
namespace FalconOne.API.Attributes
{
    ...
    public class FalconOneAuthorizeAttribute : AuthorizeAttribute, IAsyncAuthorizationFilter
    {
        private readonly string _claim;
        private IMemoryCache _cache;
        private CacheHelper _cacheHelper;

        public FalconOneAuthorizeAttribute(string claim)
        {
        ...
        {
            var userManager = GetService<UserManager<User>>(context);
            var dbContext = GetService<FalconOneContext>(context);
        ...
        private async Task<T> GetSettingValue<T>(FalconOneContext context, Guid tenantId, TenantPredefinedSettingEnum setting)
        {
        ...
        private async Task<bool> HasPermissionAsync(Guid userId, FalconOneContext context, string permission, Guid tenantId, UserManager<User> userManager)
        {
