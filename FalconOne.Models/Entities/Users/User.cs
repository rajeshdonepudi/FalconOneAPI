...
namespace FalconOne.Models.Entities.Users
{
    ...
    public class User : IdentityUser<Guid>, ITrackableEntity, ISoftDeletable, IEquatable<User>, ICloneable
    {
        public User()
        {
            ...
            SentMails = new HashSet<Mail>();
            ReceivedMails = new HashSet<UserMail>();
        ...
        public virtual ICollection<UserMail> ReceivedMails { get; set; }
        ...
        public virtual ICollection<Mail> UpdatedMails { get; set; }
        public virtual ICollection<Mail> DeletedMails { get; set; }
        #endregion
        ...
        public virtual ICollection<Attachment> UpdatedAttachments { get; set; }
        public virtual ICollection<Attachment> DeletedAttachments { get; set; }
