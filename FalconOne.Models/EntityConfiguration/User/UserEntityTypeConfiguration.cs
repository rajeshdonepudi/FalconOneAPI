...
namespace FalconOne.Models.EntityConfiguration.User
{
    ...
    public class UserEntityTypeConfiguration : IEntityTypeConfiguration<Entities.Users.User>
    {
        public void Configure(EntityTypeBuilder<Entities.Users.User> builder)
        {
            ...
            // Mail
            builder.HasMany(x => x.CreatedMails)
                .WithOne(x => x.CreatedByUser)
                .HasForeignKey(x => x.CreatedByUserId)
                .IsRequired(false)
                .OnDelete(DeleteBehavior.Restrict);

            builder.HasMany(x => x.UpdatedMails)
                .WithOne(x => x.LastUpdatedByUser)
                .HasForeignKey(x => x.LastUpdatedByUserId)
                .IsRequired(false)
                .OnDelete(DeleteBehavior.Restrict);

            builder.HasMany(x => x.DeletedMails)
                .WithOne(x => x.DeletedByUser)
                .HasForeignKey(x => x.DeletedByUserId)
                .IsRequired(false)
                .OnDelete(DeleteBehavior.Restrict);
            ...
            //
            builder.HasMany(x => x.CreatedAttachments)
                .WithOne(x => x.CreatedByUser)
                .HasForeignKey(x => x.CreatedByUserId)
                .IsRequired(false)
                .OnDelete(DeleteBehavior.Restrict);

            builder.HasMany(x => x.UpdatedAttachments)
                .WithOne(x => x.LastUpdatedByUser)
                .HasForeignKey(x => x.LastUpdatedByUserId)
                .IsRequired(false)
                .OnDelete(DeleteBehavior.Restrict);

            builder.HasMany(x => x.DeletedAttachments)
                .WithOne(x => x.DeletedByUser)
                .HasForeignKey(x => x.DeletedByUserId)
                .IsRequired(false)
                .OnDelete(DeleteBehavior.Restrict);
