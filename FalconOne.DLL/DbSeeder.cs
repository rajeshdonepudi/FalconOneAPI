...
namespace FalconOne.DAL
{
    public static class DbSeeder
    {
        ...
        private static async Task InitializeRolesAsync(FalconOneContext context, CancellationToken cancellationToken)
        {
        ...
        private static async Task SyncPermissions(FalconOneContext context, CancellationToken cancellationToken)
        {
        ...
        private static async Task CreateRootUserAsync(FalconOneContext context, CancellationToken cancellationToken)
        {
        ...
        private static async Task InitializeTenantsAsync(FalconOneContext context, CancellationToken cancellationToken)
        {
