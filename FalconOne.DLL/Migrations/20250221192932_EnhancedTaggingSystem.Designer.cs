...
namespace FalconOne.DAL.Migrations
{
    ...
    [Migration("20250221192932_EnhancedTaggingSystem")]
    partial class EnhancedTaggingSystem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FalconOne.Models.Entities.Tenants.Tenant", b =>
                {
                    ...
                    b.Property<string>("AccountAlias")
                        ...
                        .HasColumnType("nvarchar(max)")
                        .HasComputedColumnSql("CONVERT(NVARCHAR(max), 20250221192930641) + '-FALO_TEN' + CAST([AccountId] AS NVARCHAR(max))");
            ...
            modelBuilder.Entity("FalconOne.Models.Entities.Users.User", b =>
                {
                    ...
                    b.Property<string>("ResourceAlias")
                        ...
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("nvarchar(max)")
                        .HasComputedColumnSql("CONVERT(NVARCHAR(max), 20250221192930641) + '-FALO_USR' + CAST([ResourceId] AS NVARCHAR(max))");
